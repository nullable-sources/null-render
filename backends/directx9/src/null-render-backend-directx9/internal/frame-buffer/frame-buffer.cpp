...
/* 
* @note:
*  я проебал два дн€ на еблю с этим уебанским directx9.
*  ѕо итогу ниху€ не работает, это животное просто отказываетс€ рисовать √≈ќћ≈“–»ё после установки rt и отрисовки в неЄ чего-либо.
*  ѕохуй даже что именно рисовать Ц установленную текстуру или любую другую, геометри€ с текстурой ѕ–ќ—“ќ ЅЋя“№ Ќ≈ –»—”≈“—я,
*  нет никаких ошибок, ни в SetTexture, ни в DrawIndexedPrimitive.
*  ≈сли убрать msaa у msaa_buffer то всЄ будет нормально.
*  я хуй знает в чЄм проблема, может blend ебЄт мозги, может ещЄ что-то, но тратить ещЄ больше времени на это дерьмо € не собираюсь,
*  перепробовал всЄ нахуй јЅ—Ћё“Ќќ, 2 сюрфейса Ц на текстуру и rt, получение сюрфейса перед копированием, получение сюрфейса перед установкой rt, ниху€ не работает.
*
*  ≈сли кто-то решит пофиксить это говно Ц флаг в руки и дай бог здоровь€, лично € в ближайшее врем€ рот ебал тратить нервы и врем€ на эту поеботу.
*/
