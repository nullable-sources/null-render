...
namespace ntl::render::opengl3 {
    ...
    public:
        resource_t get_source() override {
            return resource_t("null-render:opengl:shaders:passthrough.frag", "null-render:opengl:resources");
        }
    ...
    public:
        resource_t get_source() override {
            return resource_t("null-render:opengl:shaders:passthrough.vert", "null-render:opengl:resources");
        }
