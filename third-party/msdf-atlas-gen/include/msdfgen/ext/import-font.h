...
bool loadGlyph(Shape &output, FontHandle *font, GlyphIndex glyphIndex, FontCoordinateScaling coordinateScaling, double *outAdvance = NULL, uint32_t glyph_flags = 0, bool embolden = false, bool oblique = false);
bool loadGlyph(Shape &output, FontHandle *font, unicode_t unicode, FontCoordinateScaling coordinateScaling, double *outAdvance = NULL, uint32_t glyph_flags = 0, bool embolden = false, bool oblique = false);
// Legacy API - FontCoordinateScaling is LEGACY
bool loadGlyph(Shape &output, FontHandle *font, GlyphIndex glyphIndex, double *outAdvance = NULL, uint32_t glyph_flags = 0, bool embolden = false, bool oblique = false);
bool loadGlyph(Shape &output, FontHandle *font, unicode_t unicode, double *outAdvance = NULL, uint32_t glyph_flags = 0, bool embolden = false, bool oblique = false);
