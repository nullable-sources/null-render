...
public:
    ...
    bool load(msdfgen::FontHandle *font, double geometryScale, msdfgen::GlyphIndex index, bool preprocessGeometry = true, uint32_t loading_flags = 0, bool embolden = false, bool oblique = false);
    bool load(msdfgen::FontHandle *font, double geometryScale, unicode_t codepoint, bool preprocessGeometry = true, uint32_t loading_flags = 0, bool embolden = false, bool oblique = false);
