...
void main_loop() {
	...
	null::render::begin_frame(window);
	{
		...
		null::render::background_draw_list.draw_text("rect filled", { 100, 200 }, { }, text_flags);
		null::render::background_draw_list.draw_rect_filled({ 50, 200 }, { 150, 300 }, color, 10.f, corner_flags);

		null::render::background_draw_list.draw_text("rect", { 250, 200 }, { }, text_flags);
		null::render::background_draw_list.draw_rect({ 200 }, { 300 }, color, 2.f, 10.f, corner_flags);

		null::render::background_draw_list.draw_text("circle filled", { 400, 200 }, { }, text_flags);
		null::render::background_draw_list.draw_circle_filled({ 400, 250 }, color, 50);

		null::render::background_draw_list.draw_text("circle", { 550, 200 }, { }, text_flags);
		null::render::background_draw_list.draw_circle({ 550, 250 }, color, 50, 0, 2.f);
	}
