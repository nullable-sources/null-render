        ...
        namespace opengl3 {
            ...
            void render_draw_data(c_draw_list::draw_data_t* _draw_data) {
                ...
                for(c_draw_list* draw_list : _draw_data->cmd_lists) {
                    ...
                    std::ranges::transform(draw_list->vtx_buffer, std::back_inserter(vertex_buffer), [](c_draw_list::vertex_t& vtx) { return vertex_t{ vtx.pos, vtx.uv, vtx.color }; });
            ...
            void setup_render_state(c_draw_list::draw_data_t* draw_data, std::uint32_t vertex_array_object) {
...
#endif
                opengl::tex_image2d(opengl::e_texture_2d, 0, opengl::e_rgba, atlas.texture.size.x, atlas.texture.size.y, 0, opengl::e_rgba, opengl::e_unsigned_byte, (void*)atlas.texture.pixels_rgba32.data());
