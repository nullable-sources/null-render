        ...
        void build(c_atlas* atlas) override {
            ...
            for(auto [src, config] : std::views::zip(src_array, atlas->configs)) {
                ...
                switch(config.render_mode) {
                	...
                	case e_font_render_mode::sdf: { utils::logger(utils::e_log_type::warning, "freetype font loader does not support sdf fonts yet."); }
            ...
            for(auto [src, config] : std::views::zip(src_array, atlas->configs)) {
                ...
                for(auto [i, glyph] : src.glyphs_list | std::views::enumerate) {
