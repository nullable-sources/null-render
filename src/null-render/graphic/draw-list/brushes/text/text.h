...
namespace null::render {
	...
	public:
		...
		template <typename self_t> auto&& set_size(this self_t&& self, float size) { self.size = size; return self; }
		template <typename self_t> auto&& set_align(this self_t&& self, e_text_align align) { self.align = align; return self; }
