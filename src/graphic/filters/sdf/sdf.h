...
namespace null::render::filters {
	...
	public:
		c_sdf(std::unique_ptr<commands::i_command>&& _child_command, void* _texture, const float& _thickness, const float& _size, const color_t<int>& _outline_start, const color_t<int>& _outline_end)
